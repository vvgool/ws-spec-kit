...
export const applicationPublicErrorGroups = {
  ...
  externalAction: [
    ...
    "WSSPEC_EXTERNAL_IDEMPOTENCY_INVALID", "WSSPEC_EXTERNAL_INTENT_INVALID", "WSSPEC_EXTERNAL_ORDER_INVALID",
    "WSSPEC_EXTERNAL_PAYLOAD_INVALID", "WSSPEC_EXTERNAL_PAYLOAD_MISMATCH", "WSSPEC_EXTERNAL_PROJECTION_INVALID",
    "WSSPEC_EXTERNAL_READBACK_MISMATCH", "WSSPEC_EXTERNAL_RECONCILIATION_FAILED", "WSSPEC_EXTERNAL_RECONCILIATION_NOT_REQUIRED",
