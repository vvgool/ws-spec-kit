...
export const applicationPublicErrorGroups = {
  ...
  approval: [
    "WSSPEC_APPROVAL_DIGEST_INVALID", "WSSPEC_APPROVAL_DIGEST_MISMATCH", "WSSPEC_APPROVAL_EXPIRED", "WSSPEC_APPROVAL_FEEDBACK_INVALID", "WSSPEC_APPROVAL_FEEDBACK_NOT_ALLOWED", "WSSPEC_APPROVAL_NOT_EXPIRED", "WSSPEC_APPROVAL_NOT_PENDING",
