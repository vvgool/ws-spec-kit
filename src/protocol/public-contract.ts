...
export const applicationPublicErrorGroups = {
  ...
  externalAction: [
    "WSSPEC_EXTERNAL_ACTION_REJECTED", "WSSPEC_EXTERNAL_ATTEMPT_MISMATCH", "WSSPEC_EXTERNAL_BINDING_INVALID",
    ...
    "WSSPEC_EXTERNAL_SECURITY_CLASS_INVALID", "WSSPEC_EXTERNAL_STATE_TRANSITION_INVALID", "WSSPEC_EXTERNAL_TARGET_INVALID",
