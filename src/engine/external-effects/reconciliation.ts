export type ExternalDeliveryStatus = "missing" | "prepared" | "approved" | "executing" | "reconciliation_required" | "verified" | "failed";
...
export function evaluateExternalDelivery(input: {
  ...
  if (input.knowledge !== "verified") {
    ...
    else if (input.knowledge === "failed" || input.knowledge === "reconciliation_required") warnings.push("WSSPEC_OPTIONAL_KNOWLEDGE_FAILED");
  }
