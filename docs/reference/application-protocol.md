...
| `submit` | `WSSPEC_ARTIFACT_REFERENCE_INVALID`、`WSSPEC_DOCUMENTATION_SCOPE_VIOLATION`、`WSSPEC_DOCUMENTATION_FILE_INVALID`、`WSSPEC_DOC_CONFLICT_MARKER`、`WSSPEC_DOC_EMPTY`、`WSSPEC_DOC_INVALID_UTF8`、`WSSPEC_LOOP_STEP_APPROVAL_UNSUPPORTED`、`WSSPEC_MODIFIED_FILES_MISMATCH`、`WSSPEC_REQUIRED_ARTIFACT_MISSING`、`WSSPEC_STEP_CONFIGURATION_INVALID`、`WSSPEC_STEP_FAILED`、`WSSPEC_STEP_FAILURE_CLASSIFICATION_INVALID`、`WSSPEC_STEP_INPUT_INVALID`、`WSSPEC_UNDECLARED_ARTIFACT`、`WSSPEC_WORKSPACE_MODE_VIOLATION` |
