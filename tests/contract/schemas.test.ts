...
const validValues: Record<string, Record<string, unknown>> = {
  ...
  "builtin.external-action-request.v1": {
    ...
    sideEffects: ["更新 Issue 正文"], createdAt: "2026-08-16T10:00:00.000Z", expiresAt: "2026-08-16T10:30:00.000Z",
    requestDigest: `sha256:${"4".repeat(64)}`,
  },
  "builtin.external-action-grant.v1": {
    version: 1, grantId: `external-grant-${"4".repeat(64)}`, requestId: `external-request-${"a".repeat(64)}`,
    ...
    approvalDigest: `sha256:${"4".repeat(64)}`, profile: "standard", profileDigest: `sha256:${"1".repeat(64)}`,
    workspaceDigest: `sha256:${"2".repeat(64)}`, configDigest: `sha256:${"3".repeat(64)}`,
    decidedAt: "2026-08-16T10:05:00.000Z", expiresAt: "2026-08-16T10:20:00.000Z", grantDigest: `sha256:${"5".repeat(64)}`,
  },
  "builtin.external-write-receipt.v1": {
    version: 1, kind: "external-write-receipt", requestId: `external-request-${"a".repeat(64)}`,
